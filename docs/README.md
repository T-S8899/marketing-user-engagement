...
Deployment is automated by `.github/workflows/pages.yml`. On pushes to `main`, GitHub Actions rebuilds `docs/`, uploads it as a Pages artifact, and deploys it. In GitHub repository settings, Pages should use GitHub Actions as the source.
